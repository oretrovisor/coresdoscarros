...
export const DATA = {
  ...
  1972: [
    ...
    { code: "C4A", name: "CINZA FENIX Metálico",      hex: "#A0A8AF", photo: ["1972-dodge-charger-rt-cinza-fenix-metalico-front.jpg", "1972-dodge-charger-rt-cinza-fenix-metalico-rear.jpg"], photoCaption: "1972 Dodge Charger R/T Cinza Fênix Metálico" },
  ...
  1973: [
    ...
    { code: "M4",  name: "MARROM AZTECA",             hex: "#B8A47A", photo: ["1973-dodge-charger-rt-marrom-azteca-front.jpg", "1973-dodge-charger-rt-marrom-azteca-rear.jpg"], photoCaption: "1973 Dodge Charger R/T Marrom Azteca" },
