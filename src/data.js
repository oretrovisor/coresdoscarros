...
export const DATA = {
  1970: [
    { code: "BEY6", name: "AMARELO CARAJÁ",        hex: "#F4E99C" },
  ...
  1972: [
    ...
    { code: "W3",  name: "BRANCO POLAR",              hex: "#EEF1F2", video: "n6MIkYQ7uVo", photo: ["1972-dodge-charger-rt-branco-polar.jpg", "1972-dodge-dart-se-branco-polar.jpg"], photoCaption: ["1972 Dodge Charger R/T Branco Polar", "1972 Dodge Dart SE Branco Polar"] },
    { code: "R8",  name: "BURGUNDY Metálico",         hex: "#5E1A2A" },
    { code: "C4A", name: "CINZA FENIX Metálico",      hex: "#A0A8AF", video: "ACq7oZfg0mQ", photo: ["1972-dodge-charger-rt-cinza-fenix-metalico-front.jpg", "1972-dodge-charger-rt-cinza-fenix-metalico-rear.jpg"], photoCaption: "1972 Dodge Charger R/T Cinza Fênix Metálico" },
    { code: "R5",  name: "MARROM CASTANHA Metálico",  hex: "#5A3A26", video: "D6hhKdACHVk" },
    { code: "M4",  name: "MARROM AZTECA",             hex: "#B8A47A" },
  ...
  1975: [
    ...
    { code: "LX9", name: "PRETO BAIXO BRILHO/ONIX",   hex: "#1A1A1A", video: ["JPE7EeCHWWY", "Exbbo_CyMMQ"], photo: ["1975-dodge-charger-rt-preto-baixo-brilho-1.jpg", "1975-dodge-charger-rt-preto-baixo-brilho-2.jpg"], photoCaption: "1975 Dodge Charger R/T Preto Baixo Brilho / Ônix" },
    { code: "LF2", name: "VERDE AUSTRÍACO",           hex: "#2F4A35", unconfirmed: true },
    { code: "LG4", name: "VERDE PINHO",               hex: "#2F4A32", video: "2w48N7qHevc" },
    { code: "LR7", name: "VERMELHO AZTECA",           hex: "#711E2A", video: ["a4cbli2ObYU", "Pl6nGRD9Ebo"], photo: ["1975-dodge-charger-rt-vermelho-azteca-front.jpg", "1975-dodge-charger-rt-vermelho-azteca-rear.jpg"], photoCaption: "1975 Dodge Charger R/T Vermelho Azteca" },
  ...
  1979: [
    ...
    { code: "AZ1", name: "AZUL ESTELAR / AZUL CADETE",           hex: "#2A4A78", hex2: "#4A6B8A", models: ["Magnum", "Charger R/T"] },
    ...
    { code: "MA1", name: "MARROM SUMATRA / BEGE CASHMERE",       hex: "#B0693A", hex2: "#D7C39A", models: ["Magnum", "Charger R/T"], photo: "1980-dodge-charger-marrom-sumatra-bege-cashmere.jpg", photoCaption: "1980 Dodge Charger Marrom Sumatra / Bege Cashmere" },
    { code: "LX9", name: "PRETO BAIXO BRILHO/ONIX",             hex: "#1A1A1A" },
    { code: "SR5", name: "VERMELHO ALCAZAR",                     hex: "#8C1E22", video: "IdcdeJt9ZcY" },
  ],
  1980: [
    { code: "SB3",     name: "AZUL CADETE",                hex: "#4A6B8A" },
    { code: "TB2/TC2", name: "AZUL GEADA",                 hex: "#9BAEC0", photo: "1980-dodge-charger-rt-azul-geada.jpg", photoCaption: "1980 Dodge Charger R/T Azul Geada" },
  ...
  1981: [
    ...
    { code: "L8C", name: "MARROM AVELÃ",              hex: "#8A6A4A", video: "dUP1TFcYfeM" },
    ...
    { code: "L6A", name: "VERDE TURMALINA",           hex: "#7EA89B", video: ["lD01X9vOC_g", "5fV6Jdq3B-U"], photo: "1981-dodge-dart-coupe-verde-turmalina.jpg", photoCaption: "1981 Dodge Dart Coupé Verde Turmalina" },
