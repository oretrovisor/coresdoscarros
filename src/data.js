...
export const DATA = {
  ...
  1979: [
    ...
    { code: "MA1", name: "MARROM SUMATRA / BEGE CASHMERE",       hex: "#B0693A", hex2: "#D7C39A", models: ["Magnum", "Charger R/T"], photo: "1979-dodge-magnum-marrom-sumatra-bege-cashmere.jpg", photoCaption: "1979 Dodge Magnum Marrom Sumatra / Bege Cashmere" },
    { code: "LX9", name: "PRETO BAIXO BRILHO/ONIX",             hex: "#1A1A1A" },
