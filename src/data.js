...
export const DATA = {
  ...
  1972: [
    ...
    { code: "V7",  name: "VERDE IGARAPÉ Metálico",    hex: "#3F6B4A", video: "B7H_c6TpQeM" },
  ...
  1973: [
    ...
    { code: "G4",  name: "VERDE FLORESTA",            hex: "#5A7A45", video: "cJNf9qjSSqw" },
  ...
  1975: [
    ...
    { code: "LR3", name: "VERMELHO DINASTIA",         hex: "#D8392B", photo: "1975-dodge-charger-vermelho-dinastia.jpg", photoCaption: "1975 Dodge Charger Vermelho Dinastia" },
  ],
  1976: [
  ...
  1979: [
    ...
    { code: "PR1", name: "CINZA BALTICO / PRETO BAIXO BRILHO",   hex: "#5A5A56", models: ["Magnum"] },
